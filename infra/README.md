...
面向个人及最多 10 人受邀协作的正式上线，按照 [`runbooks/aliyun-production-release.md`](runbooks/aliyun-production-release.md) 完成生产门禁、HTTPS、监控告警、异地备份、发布观察、旧版本清理和回滚。该手册中的阻断项未全部完成时，环境仍保持 staging 状态。
