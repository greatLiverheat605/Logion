...
阿里云 2 核 2 GB、无域名的封闭技术测试部署，按照 [`runbooks/aliyun-2c2g-staging-deployment.md`](runbooks/aliyun-2c2g-staging-deployment.md) 逐步执行。该手册不批准 Production，也不能替代域名/HTTPS、异地备份、真实邮件、告警和生产型容量门禁。
