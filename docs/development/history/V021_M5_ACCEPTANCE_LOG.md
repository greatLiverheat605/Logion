...
> 原文件字节 SHA-256：`d28b41dc86d33ce2fb85dba374b8d8b3eb913fdbedb93d7a6f5fad88fa19f121`。正文仅调整移入本目录后的相对链接与 Markdown 格式，历史失败、授权与未运行项保留。
