...
- 仓库：Logion；
- 基线提交：`769f61f9bd2166b73e7dd45671b4e468ade0eeed`；
- 基线分支：`codex/v020-rc6-closeout`；
- 目标工作区与工作分支：派发时由协调方填写；
- 开始前必须确认上述提交可达，并报告实际绝对路径、分支、HEAD 和工作树状态；
- 当前批准的产品文档尚未形成用户授权的 commit/push。若目标工作区看不到本任务列出的三份批准文档，必须停止并报告，不得根据聊天摘要自行补写或跨机器猜测内容。
