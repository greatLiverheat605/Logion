...
> 当前状态：仓库清单版本仍为 `0.1.0`；`v0.2.0-rc6` 已部署到受控 prerelease，尚未进入 Production。I0 Adaptive Desk 重构候选位于 `codex/logion-redesign-i0`，已完成本机技术验收，仍需 PR、远端门禁和合并审批。真实邮件、实体设备、观察期与生产流量切换仍未完成。
